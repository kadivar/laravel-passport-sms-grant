...
This package is useful to combine your Oauth2 Server with SMS Login. This is a re-published, re-organized and maintained version of [xutl/laravel-passport-sms](https://github.com/xutl/laravel-passport-sms).
...
```
composer require kadivar/laravel-passport-sms-grant:dev-master
```
...
'providers' => [
    ...
    "Kadivar\Passport\Sms\SmsLoginGrantProvider::class,
    ...
];
```
## How to use
